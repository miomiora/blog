import{_ as n,V as s,W as a,a0 as t}from"./framework-2d083801.js";const p={},o=t(`<h2 id="不太行的" tabindex="-1"><a class="header-anchor" href="#不太行的" aria-hidden="true">#</a> 不太行的</h2><p>前后端分离的项目中，传统的 <code>MVC</code> 架构中的 <code>V</code> 已经被抽离出去</p><p>在我之前做的项目中的架构分层都感觉不是很行，在我之前的 <code>mio-api</code> 项目分层如下</p><div class="language-bash" data-ext="sh"><pre class="language-bash"><code>│  go.mod
│  go.sum
│  main.go
│  settings.yaml
│
